...
contract ERC721BurnableExtension is IERC721CreatorExtensionBurnable, ERC721Extension {
    uint256[] public burntTokens;

    constructor(address creator) ERC721Extension(creator) {}

    function supportsInterface(bytes4 interfaceId) public pure returns (bool) {
        return interfaceId == 0xf3f4e68b // LEGACY_ERC721_EXTENSION_BURNABLE_INTERFACE
            || interfaceId == type(IERC721CreatorExtensionBurnable).interfaceId || interfaceId == type(IERC165).interfaceId;
    }
