...
function shouldBehaveLikeERC1155([minter, firstTokenHolder, secondTokenHolder, multiTokenHolder, recipient, proxy]) {
  ...
  describe('like an ERC1155', function () {
    describe('balanceOf', function () {
      ...
      context('when accounts own some tokens', function () {
        beforeEach(async function () {
          await this.token.testMint(firstTokenHolder, firstTokenId, firstAmount, '0x', {
            from: minter,
          });
          await this.token.testMint(secondTokenHolder, secondTokenId, secondAmount, '0x', {
            from: minter,
          });
        });
    ...
    describe('safeTransferFrom', function () {
      beforeEach(async function () {
        await this.token.testMint(multiTokenHolder, firstTokenId, firstAmount, '0x', {
          from: minter,
        });
        await this.token.testMint(multiTokenHolder, secondTokenId, secondAmount, '0x', {
          from: minter,
        });
      });
